                ...
                <table class="table mb-0">
                    <thead style="background: #fdf0f5;">
                        <tr>
                            ...
                            <th style="color: #c07090; font-weight: 600;">ASSIGNED TO</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label" style="color: #a04070; font-weight: 600;">Assign to Staff Member <span style="color: red;">*</span></label>
                    <select id="addUserId" class="form-control" required>
...
<script>
    ...
    function editProject(id, name, description, startDate, endDate, status, progress, userId) {
        currentProjectId = id;
    ...
    function handleAddProject() {
        ...
        if (!userId) {
            alert('Please select a staff member to assign the project to.');
            return;
        }
