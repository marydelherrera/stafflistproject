...
<div style="display: flex; min-height: 100vh;">
    ...
    <div style="width: 230px; background: #f3c9d9; padding: 20px; overflow-y: auto; flex-shrink: 0;">
        ...
        <a href="/staff/tasks" class="btn btn-sm w-100 text-start mb-2" style="color: #a04070; background: #f7dce8;">
    ...
    <div style="flex: 1; padding: 25px; overflow-y: auto;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            <div>
                <h2 style="font-family: 'Cormorant Garamond', serif; color: #a04070; font-size: 2rem; margin: 0;">My Tasks</h2>
                <div style="font-size: 12px; color: #c07090;">Manage your assigned projects</div>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header" style="background: #f7dce8; border: none; padding: 15px;">
                <strong style="color: #a04070;">ALL MY TASKS</strong>
            </div>
                ...
                <table class="table mb-0">
                    <thead style="background: #fdf0f5;">
                        <tr>
                            ...
                            <th style="color: #c07090; font-weight: 600;">DESCRIPTION</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ Str::limit($project->description ?? 'N/A', 50) }}</td>
                            <td>
                                @php
                                    $statusColors = [
                            ...
                            <td>
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    <div class="progress" style="flex: 1; height: 8px; border-radius: 4px; min-width: 60px;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="form-label" style="color: #a04070; font-weight: 600;">Estimated Completion Date</label>
                    <input type="date" id="submitEndDate" class="form-control">
                </div>

                <div class="mb-3">
                    <label class="form-label" style="color: #a04070; font-weight: 600;">Description <span style="color: red;">*</span></label>
...
<script>
    function openSubmitModal(projectId, projectName, progress) {
        ...
        document.getElementById('submitEndDate').value = '';
    ...
    function submitWork() {
        ...
        const endDate     = document.getElementById('submitEndDate').value;
